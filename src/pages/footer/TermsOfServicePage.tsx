              ...
              <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                <div className="flex justify-center mb-4 sm:mb-6">
                  <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-3 sm:p-4">
                    <Scale className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-blue-400" />
                  </div>
                </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold text-white">2. Description of Service</h2>
                  </div>
                  <div className="space-y-4 sm:space-y-6 text-white/80">
                    ...
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Code Analysis</h3>
                      <p className="text-xs sm:text-sm mb-2">Performance insights including memory usage, space utilization, execution speed, and other parameters that impact code performance and efficiency.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Code Optimization</h3>
                      <p className="text-xs sm:text-sm mb-2">Automated enhancement of uploaded code with detailed explanations of improvements made, including quantified benefits in terms of execution time, server runtime, memory consumption, and associated cost savings.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Code Transformation</h3>
                      <p className="text-xs sm:text-sm mb-2">Conversion of code between supported programming languages (Python, R, and SAS) while maintaining functional equivalency.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Code Documentation</h3>
                      <p className="text-xs sm:text-sm mb-2">Addition of comprehensive comments and explanatory annotations to improve code readability and maintainability.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold text-white">3. User Accounts and Registration</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <AlertTriangle className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">4. Acceptable Use Policy</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">5. Intellectual Property Rights</h2>
                  </div>
                  <div className="space-y-4 sm:space-y-6 text-white/80">
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Your Code</h3>
                      <p className="text-xs sm:text-sm mb-2">You retain ownership of the original code you upload to the Service. By uploading code, you grant us a limited, non-exclusive license to process, analyze, and optimize your code using our LLM-powered tools for the sole purpose of providing the requested services.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Service Output</h3>
                      <p className="text-xs sm:text-sm mb-2">The optimized code, analysis reports, transformations, and documentation generated by our Service are provided to you under a non-exclusive license. While you may use these outputs for your intended purposes, the underlying methodologies, algorithms, and LLM models remain our proprietary technology.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Platform Technology</h3>
                      <p className="text-xs sm:text-sm mb-2">All rights, title, and interest in the Service, including our optimization algorithms, user interface, and LLM integration, remain exclusively with the Company.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <Shield className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">6. Data Processing and Privacy</h2>
                  </div>
                  <div className="space-y-4 sm:space-y-6 text-white/80">
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Code Processing</h3>
                      <p className="text-xs sm:text-sm mb-2">Your uploaded code is processed using third-party LLM APIs to provide optimization, analysis, transformation, and documentation services. We implement appropriate technical and organizational measures to protect your code during processing.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Data Retention</h3>
                      <p className="text-xs sm:text-sm mb-2">Uploaded code and generated outputs may be temporarily stored on our servers to facilitate service delivery. We will retain your data only for as long as necessary to provide the requested services, unless longer retention is required by law.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Third-Party LLM Providers</h3>
                      <p className="text-xs sm:text-sm mb-2">Our Service utilizes external LLM APIs, which may process your code according to their respective privacy policies and terms of service. By using our Service, you acknowledge and consent to this processing.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Confidentiality</h3>
                      <p className="text-xs sm:text-sm mb-2">We will not intentionally disclose your uploaded code or generated outputs to unauthorized third parties, except as required by law or as necessary to provide the Service.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">7. Service Availability and Performance</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <AlertTriangle className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">8. Limitation of Liability</h2>
                  </div>
                  <div className="space-y-4 sm:space-y-6 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <Shield className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">9. User Responsibilities and Warranties</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">10. Indemnification</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <AlertTriangle className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">11. Termination</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">12. Modifications to Terms</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold text-white">13. Governing Law and Dispute Resolution</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">14. Miscellaneous Provisions</h2>
                  </div>
                  <div className="space-y-4 sm:space-y-6 text-white/80">
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Severability</h3>
                      <p className="text-xs sm:text-sm mb-2">If any provision of these Terms is deemed invalid or unenforceable, the remaining provisions shall continue in full force and effect.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Entire Agreement</h3>
                      <p className="text-xs sm:text-sm mb-2">These Terms constitute the entire agreement between you and the Company regarding the Service and supersede all prior agreements and understandings.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Assignment</h3>
                      <p className="text-xs sm:text-sm mb-2">You may not assign or transfer your rights under these Terms without our written consent. We may assign our rights and obligations under these Terms at any time.</p>
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Force Majeure</h3>
                      <p className="text-xs sm:text-sm mb-2">We shall not be liable for any failure to perform due to circumstances beyond our reasonable control, including but not limited to acts of God, government actions, or third-party service interruptions.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
                    <h2 className="text-xl sm:text-2xl font-bold text-white">15. Contact Information</h2>
                  </div>
                  <div className="space-y-3 sm:space-y-4 text-white/80">
                    <p className="text-xs sm:text-sm">
