            ...
            <div className="max-w-4xl mx-auto px-4">
              ...
              <div className="space-y-8">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-2xl p-8">
                  ...
                  <div className="space-y-6 text-white/80">
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-3">Session Management</h3>
                      <p className="text-sm mb-2">Cookies maintain your authenticated state while you use our platform, ensuring that you remain logged in as you navigate between different features of our code optimization Service. These cookies expire when you close your browser or log out of your account, providing security while maintaining convenience during your active session.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-3">User Experience Optimization</h3>
                      <p className="text-sm mb-2">This involves using cookies to remember your preferences and settings, such as your preferred code display format, optimization parameters, and interface layout. This personalization ensures that our Service adapts to your working style and provides a consistent experience across your visits to our platform.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-3">Platform Performance Monitoring</h3>
                      <p className="text-sm mb-2">This utilizes cookies to collect technical information about how our Service performs on your device, including page load times, feature response rates, and system compatibility. This data helps us optimize our code processing algorithms and ensure that our LLM-powered optimization tools operate efficiently across different user environments.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-3">Analytics and Improvement</h3>
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-2xl p-8">
                  ...
                  <div className="space-y-4 text-white/80">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">Cookie Categories</h3>
                      <p className="text-sm mb-2">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">Regular Management</h3>
                      <p className="text-sm mb-2">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">Platform-Specific Controls</h3>
                      <p className="text-sm mb-2">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-2xl p-8">
                  ...
                  <div className="space-y-4 text-white/80">
                    <div>
                      ...
                      <p className="text-sm mb-2">Expire automatically when you close your browser or log out of our Service. These temporary cookies are essential for maintaining your active session and ensuring secure access to your account and uploaded code during your visit to our platform.</p>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">Persistent Cookies</h3>
                      <p className="text-sm mb-2">Remain on your device for predetermined periods or until you manually delete them through your browser settings. These cookies typically store user preferences and settings that enhance your experience across multiple visits to our Service. The retention periods for persistent cookies vary based on their specific functions and purposes.</p>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">Automatic Expiration</h3>
                      <p className="text-sm mb-2">Occurs when cookies reach their predetermined expiration dates, at which point they are automatically removed from your device. We set appropriate expiration periods for different types of cookies based on their functions and your privacy interests.</p>
                    </div>
                    <div>
