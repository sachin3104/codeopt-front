        ...
        <main className="flex-grow">
          <section className="pt-24 sm:pt-32 lg:pt-40 pb-12 sm:pb-16 lg:pb-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="backdrop-blur-md bg-gradient-to-br from-black/40 via-black/30 to-black/20 border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-12 space-y-4 sm:space-y-6">
                <div className="prose prose-invert max-w-none">
                  ...
                  <p className="text-white/90 text-base sm:text-lg leading-relaxed mt-4 sm:mt-6">
                  ...
                  <p className="text-white/90 text-base sm:text-lg leading-relaxed mt-6 sm:mt-8">
