          ...
          ...new Array(2).fill(0).map((_, index) => (
            <React.Fragment key={index}>
              {props.testimonials.map(({ text, image, name, role }, i) => (
                <div 
                  key={i}
                  className="p-10 rounded-3xl backdrop-blur-md bg-black/30 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-black/40 group"
                >
                  ...
                  <div className="flex items-center gap-2 mt-5">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="leading-5 text-white/60 tracking-tight">{role}</div>
                    </div>
                  </div>
                </div>
              ))}
